...
\newpage	
\begin{tabularx}{\linewidth}{X X Y}
\caption{\label{tab:Inconsistencies}Inconsistencies in diabetes self-report in MxFLS}\\
\toprule
\multicolumn{1}{c}{Inconsistency}  & \multicolumn{1}{c}{Assumption}  & Number of observations replaced\tabularnewline
\midrule \endhead
